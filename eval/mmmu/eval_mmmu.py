...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-path', type=str, default=None, help="The path to model output file.")
    parser.add_argument('--answer_path', type=str, default="eval/mmmu/answer_dict_val.json", help="Answer file path.")
