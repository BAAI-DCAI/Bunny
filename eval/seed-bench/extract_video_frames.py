...
dimension10_dir = "eval/seed-bench/SEED-Bench-video/20bn-something-something-v2"
# root directory of evaluation dimension 11
dimension11_dir = "eval/seed-bench/SEED-Bench-video/EPIC-KITCHENS"
# root directory of evaluation dimension 12
dimension12_dir = "eval/seed-bench/SEED-Bench-video/BreakfastII_15fps_qvga_sync"
...
if __name__ == "__main__":
    data = json.load(open('eval/seed-bench/SEED-Bench.json'))
    video_img_dir = 'eval/seed-bench/SEED-Bench-video-image'
